...
} from "execute/growthy-ai-panel/AIGenerateContent";
...
const blogArticleXml = `<BlogArticle>
<Title name="Embarking on the Journey of Sanskrit: A Personal Odyssey" />
<Outline>
  <Section name="Introduction to My Sanskrit Journey">
    <Task name="Share personal background" />
...
const AIGenerateContentStory: React.FC<AIGenerateContentProps> = ({
  ...props
}) => {
  return (
    <FixtureWrapper>
      <AIGenerateContent {...props} />
    </FixtureWrapper>
  );
};

const meta = {
  title: "Execute/Growthy AI Panel/AIGenerateContent",
  component: AIGenerateContentStory,
  tags: ["autodocs"],
  args: {},
} satisfies Meta<typeof AIGenerateContent>;
...
export const BaseCase: Story = {
  args: {
    blogArticleInputs: {
      ...
      blog_article_xml: blogArticleXml,
    },
